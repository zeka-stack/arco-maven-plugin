...
class BootSlotterTest {
    ...
    @Test
    void test_2() {
        String orginalMainClass1 = "dev.dong4j.zeka.maven.plugin.boot";
        Assertions.assertEquals("dev/dong4j/zeka/maven/plugin/boot", orginalMainClass1.replaceAll("\\.",
            Matcher.quoteReplacement(File.separator)));
        String orginalMainClass2 = "dev.dong4j.zeka.maven.plugin.boot";
        Assertions.assertEquals("dev/dong4j/zeka/maven/plugin/boot", orginalMainClass2.replace(".",
            Matcher.quoteReplacement(File.separator)));
    }
}
