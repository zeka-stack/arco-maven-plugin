...
/**
 * 扩展文件操作工具类，在Apache Commons IO基础上提供了额外的文件处理能力
 * <p>
 * 该工具类继承自Apache Commons IO的FileUtils，在保持原有功能的同时
 * 增加了专门针对Maven插件开发和部署场景的定制化文件操作功能
 * <p>
 * 核心功能特性：
 * <ul>
 *     <li>资源文件处理 - 从classpath读取资源文件并写入目标位置</li>
 *     <li>文件内容读取 - 一站式读取classpath资源为字符串</li>
 *     <li>文件流操作 - 高效的输入输出流处理和拷贝</li>
 *     <li>类存在检测 - 反射机制检测类是否在classpath中存在</li>
 *     <li>路径拼接 - 跨平台的文件路径安全拼接</li>
 *     <li>目录管理 - 递归删除空目录和整个目录树</li>
 *     <li>权限管理 - POSIX文件权限设置和可执行权限管理</li>
 * </ul>
 * <p>
 * 该工具类特别针对Maven插件的使用场景进行了优化，支持了常见的构建任务
 * 如程序集打包、脚本文件生成、资源文件拷贝等常见操作
 * <p>
 * 技术实现亮点：
 * <ul>
 *     <li>统一UTF-8编码 - 所有文本文件操作统一使用UTF-8编码</li>
 *     <li>异常安全 - 完善的资源管理和异常处理机制</li>
 *     <li>跨平台兼容 - 支持Windows和Unix类系统的文件操作</li>
 *     <li>性能优化 - 高效的NIO文件操作和批量处理</li>
 * </ul>
 * <p>
 * 使用场景：
 * <ul>
 *     <li>Maven插件中的模板文件处理和生成</li>
 *     <li>应用打包过程中的文件拷贝和整理</li>
 *     <li>部署脚本和启动脚本的生成和权限设置</li>
 *     <li>依赖检查和类路径验证</li>
 *     <li>清理临时文件和构建产物</li>
 * </ul>
 * <p>
 * 高级特性：
 * <ul>
 *     <li>智能路径处理 - 自动处理路径分隔符和特殊字符</li>
 *     <li>POSIX权限支持 - 完整的Unix文件权限管理能力</li>
 *     <li>递归操作 - 安全的递归目录遍历和批量处理</li>
 *     <li>内存优化 - 高效的流式处理和大文件支持</li>
 * </ul>
 *
 * @author dong4j
 * @version 1.0.0
